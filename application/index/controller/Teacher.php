...
use app\model\Teacher as TeaModel;
...
class Student extends Controller{
	public function _initialize()
	{
		...
		}else 
		{
			...
			$tea=TeaModel::get(['username'=>$username]);
			$this->teaid=$tea['teacher_id'];
			//$this->new_task_number=$stu['new_task_number'];
			$this->assign('teaid',$tea['teacher_id']);
			$this->assign('realname',$tea['realname']);
